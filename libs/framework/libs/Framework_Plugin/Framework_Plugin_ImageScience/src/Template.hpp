...
#if defined(Framework_Plugin_ImageScience)
#  define Framework_Plugin_ImageScience_EXPORT Q_DECL_EXPORT
#else
#  define Framework_Plugin_ImageScience_EXPORT Q_DECL_IMPORT
#endif
